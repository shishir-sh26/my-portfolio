...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // --- FIX: Handle mouse events globally on window ---
    const handleWindowMouseMove = (event: MouseEvent) => {
      ...
      if (parallax) {
        ...
        const offsetX = (event.clientX - rect.left - centerX) / rect.width;
        const offsetY = -(event.clientY - rect.top - centerY) / rect.height;
    ...
    if (interactive) {
      // Use window listener to capture events through overlays
