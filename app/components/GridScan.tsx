...
export default function GridScan({
  ...
  useEffect(() => {
    ...
    // UPDATED: Listen to window events for global mouse movement
    const onMove = (e: MouseEvent) => {
      ...
      // Calculate normalized coordinates (-1 to +1) based on the container rect
      // If the container is full screen, this works for global movement
    ...
    // Attach listeners to window for movement to ensure capture over other elements
    window.addEventListener('mousemove', onMove);
    
    // Keep specific element listeners for enter/leave context if needed, 
    // but for full background, window events are usually sufficient.
